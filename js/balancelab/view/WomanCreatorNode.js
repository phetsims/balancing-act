...
/**
 * This type represents an adult woman in a tool box.  When the user clicks
...
define( function( require ) {
   ...
   * @constructor
   */
  function WomanCreatorNode( model, mvt ) {
    ImageMassCreatorNode.call( this, model, mvt, new Woman(), true );
  ...
  return inherit( ImageMassCreatorNode, WomanCreatorNode );
} );